...
<html lang="en">
    ...
    <body id="myPage">
        ...
        <!-- Body -->
        <div class="primary" align="center" id="contact">
            <h1>Contact</h1>
            ...
            <form align="center" action="contact_process.php" method="post">
                ...
                <p><input id="name" name="name" maxlength="50" placeholder="Type name" type="text" size="48" required></p>
                <p><input id="email" name="email" maxlength="50" placeholder="Type email" type="email" size="48" required></p>
                <p><textarea id="message" name="message" placeholder="Type message" row="5" cols="80"></textarea></p>
