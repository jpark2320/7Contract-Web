...
<html lang="en">
	...
	<body id="page-top">
		...
		<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
			<a class="navbar-brand" href="#page-top">Seven Contract LLC.</a>
		...
		<div class="container">
		  <div class="row">
			<div class="col-lg-12 text-center">
			  ...
			  <h3 class="section-subheading text-muted">(678)727-3371<br>sevencontract@gmail.com</h3>
			  <h3 class="section-subheading text-muted">Feel free to ask us anytime!</h3>
			</div>
		  </div>
		  <div class="row">
			<div class="col-lg-12">
